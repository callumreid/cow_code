...
- The default branch in this repo is `main` (since 2026-09-16), and it is always the latest version. Push finished work directly to `main`, or merge it into `main` yourself; never leave it on a side branch waiting for Callum to ask. `dev` and `feat/cow-ui` are frozen history, not targets.
