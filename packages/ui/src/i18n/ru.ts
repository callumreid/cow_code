export const dict = {
  ...
  "ui.sessionTurn.status.runningTool": "Выполняется {{tool}}…",
  "ui.sessionTurn.status.responding": "Отвечает",
  "ui.sessionTurn.status.working": "Работает",
  "ui.sessionTurn.status.grazing": "Пасётся",
