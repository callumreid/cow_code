export const dict = {
  ...
  "ui.sessionTurn.status.runningTool": "กำลังรัน {{tool}}…",
  "ui.sessionTurn.status.responding": "กำลังตอบ",
  "ui.sessionTurn.status.working": "กำลังทำงาน",
  "ui.sessionTurn.status.grazing": "กำลังเล็มหญ้า",
