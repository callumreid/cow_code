export const dict: Record<string, string> = {
  ...
  "ui.promptInput.placeholder.normal": "you got this, big dog — {{slash}} for commands, {{at}} for context...",
  "ui.promptInput.placeholder.bigdog.2": "go forth, big dog — {{slash}} for commands, {{at}} for context...",
  "ui.promptInput.placeholder.bigdog.3": "let em rip, big dog — {{slash}} for commands, {{at}} for context...",
  "ui.promptInput.placeholder.bigdog.4": "make it happen, big dog — {{slash}} for commands, {{at}} for context...",
  "ui.promptInput.placeholder.bigdog.5": "the barn is yours, big dog — {{slash}} for commands, {{at}} for context...",
  "ui.promptInput.placeholder.bigdog.6": "what are we building, big dog — {{slash}} for commands, {{at}} for context...",
  "ui.promptInput.placeholder.bigdog.7": "say the word, big dog — {{slash}} for commands, {{at}} for context...",
  "ui.promptInput.placeholder.bigdog.8": "chase it down, big dog — {{slash}} for commands, {{at}} for context...",
  "ui.promptInput.placeholder.bigdog.9": "back at it, big dog — {{slash}} for commands, {{at}} for context...",
  "ui.promptInput.placeholder.bigdog.10": "swing big, big dog — {{slash}} for commands, {{at}} for context...",
  "ui.promptInput.placeholder.bigdog.11": "giddyup, big dog — {{slash}} for commands, {{at}} for context...",
  "ui.promptInput.placeholder.bigdog.12": "big dog hours — {{slash}} for commands, {{at}} for context...",
