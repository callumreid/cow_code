export const dict = {
  ...
  "ui.sessionTurn.status.runningTool": "تشغيل {{tool}}…",
  "ui.sessionTurn.status.responding": "جارٍ الرد",
  "ui.sessionTurn.status.working": "جارٍ العمل",
  "ui.sessionTurn.status.grazing": "يرعى العشب",
