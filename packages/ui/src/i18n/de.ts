...
export const dict = {
  ...
  "ui.sessionTurn.status.runningTool": "Führe {{tool}} aus…",
  "ui.sessionTurn.status.responding": "Antwortet",
  "ui.sessionTurn.status.working": "Arbeitet",
  "ui.sessionTurn.status.grazing": "Grasen",
