export const dict = {
  ...
  "ui.sessionTurn.status.runningTool": "Uruchamianie {{tool}}…",
  "ui.sessionTurn.status.responding": "Odpowiadanie",
  "ui.sessionTurn.status.working": "Pracuje",
  "ui.sessionTurn.status.grazing": "Pasie się",
