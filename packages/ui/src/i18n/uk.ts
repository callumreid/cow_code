export const dict: Record<string, string> = {
  ...
  "ui.sessionTurn.status.runningTool": "Виконується {{tool}}…",
  "ui.sessionTurn.status.responding": "Відповідає",
  "ui.sessionTurn.status.working": "Працює",
  "ui.sessionTurn.status.grazing": "Пасеться",
