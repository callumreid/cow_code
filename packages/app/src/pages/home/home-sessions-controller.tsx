...
import { compareSessionTime, displayName, errorMessage, isOfficeOverseerSession, projectForSession } from "@/pages/layout/helpers"
...
function buildHomeSessionRecords(input: {
  ...
  const sessions = input
    ...
    .filter(
      (session) =>
        directories.has(pathKey(session.directory)) && !isOfficeOverseerSession(session) && !input.isHiddenSession(session),
    )
