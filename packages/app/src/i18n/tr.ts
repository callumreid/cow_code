...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "cow_code tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve cow_code'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve cow_code'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak cow_code'da {{provider}} modellerini kullanın.",
  ...
  "prompt.action.dictate": "Dikte et",
  "prompt.action.stopDictation": "Kaydı durdur",
  "prompt.dictation.transcribing": "Yazıya dökülüyor…",
  "prompt.dictation.error": "Ses yazıya dökülemedi",
  "prompt.dictation.noMicPermission": "Dikte için mikrofon erişimi gerekli",
  "prompt.dictation.noProvider": "Sesli dikteyi etkinleştirmek için OpenAI'yi bağlayın (veya OPENAI_API_KEY ayarlayın)",
  ...
  "dialog.server.description": "Bu uygulamanın hangi cow_code sunucusuna bağlanacağını değiştirin.",
  ...
  "context.usage.subagents": "Alt ajanlar",
  "work.empty": "Şu anda çalışan bir şey yok",
  "work.tools.title": "Çalışan araçlar",
  "work.subagents.title": "Alt ajanlar",
  "work.badge.background": "arka plan",
  "work.badge.retrying": "Yeniden deneniyor",
  "work.tokens": "{{count}} token",
  "work.chip.running": "{{count}} çalışıyor",
  "work.open": "Devam eden çalışmayı görüntüle",
  "work.finished.title": "Tamamlandı",
  "work.finished.clear": "Temizle",
  "work.status.completed": "Bitti",
  "work.status.error": "Başarısız",
  "work.chip.finished": "{{count}} tamamlandı",
  "work.column.status": "Durum",
  "work.column.duration": "Süre",
  "work.column.tokens": "Token",
  "work.column.cost": "Maliyet",
  ...
  "toast.update.description": "cow_code'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı cow_code ekibine bildirin",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: cow_code henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "notification.session.stuck.title": "Oturum takılmış olabilir",
  "notification.session.stuck.silentDescription": "{{sessionTitle}} {{minutes}} dakikadır etkinlik olmadan meşgul",
  "notification.session.stuck.retryDescription": "{{sessionTitle}} yeniden denemeye devam ediyor (deneme {{attempt}})",
  "status.connection.reconnecting": "Bağlantı koptu — yeniden bağlanılıyor…",
  "toast.sidecarExit.title": "Yerel sunucu durdu",
  "toast.sidecarExit.description": "Yerel opencode sunucusu beklenmedik şekilde kapandı (kod {{code}}).",
  "toast.sidecarExit.action.restart": "Uygulamayı yeniden başlat",
  ...
  "sidebar.gettingStarted.line1": "cow_code ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "settings.desktop.wsl.description": "cow_code sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "cow_code'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "cow_code'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "cow_code'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "cow_code'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "cow_code başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "cow_code'un en son sürümünü kullanıyorsunuz.",
  ...
  "settings.general.notifications.stuck.title": "Takılan oturumlar",
  "settings.general.notifications.stuck.description":
    "Meşgul bir oturum ilerlemeyi bıraktığında sistem bildirimi göster",
  ...
  "settings.general.sounds.moo.title": "Tamamlanınca möle",
  "settings.general.sounds.moo.description": "Pencere odakta değilken bir tur tamamlandığında yumuşak bir möleme çal",
  ...
  "settings.permissions.tool.memory.title": "Bellek",
  "settings.permissions.tool.memory.description": "Kalıcı bellek dosyalarını oluşturma, güncelleme veya silme",
  ...
  "command.browser.new": "Yeni tarayıcı sekmesi",
  "command.browser.new.description": "Tarayıcı panelinde yeni bir sekme aç",
  "command.work.open": "Etkinlik panelini aç",
  "command.work.open.description": "Bu oturumun süren ve tamamlanan işlerini göster",
  "browser.title": "Tarayıcı",
  "browser.tab.untitled": "Yeni sekme",
  "browser.tab.close": "Sekmeyi kapat",
  "browser.urlbar.placeholder": "Bir URL girin",
  "browser.action.back": "Geri",
  "browser.action.forward": "İleri",
  "browser.action.reload": "Yenile",
  "browser.action.stop": "Yüklemeyi durdur",
  "browser.empty": "Gezinmek için bir URL girin",
