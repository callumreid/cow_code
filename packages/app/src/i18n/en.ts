...
export const dict = {
  ...
  "office.host.missing": "The task is no longer available on its original host.",
  "office.host.status.available": "available",
  "office.host.status.unavailable": "unavailable",
  "office.host.status.loading": "loading",
  "office.host.status.stale": "stale",
  "office.loadingRoster": "Loading the roster…",
  "office.recovery": "{{count}} interrupted operations need reconciliation; inspect their tasks before continuing.",
  ...
  "office.outcome.unverified": "Objective unverified",
  "office.outcome.reported": "Outcome reported by the agent",
  "office.outcome.verified": "Objective verified",
  "office.evidence.implementation": "Implementation",
  "office.evidence.check": "Checks",
  "office.evidence.shipment": "Shipped",
  "office.evidence.runtime": "Live result",
  "office.evidence.verified": "evidence available",
  "office.evidence.reported": "reported",
  "office.evidence.unverified": "unverified",
  "routine.correlation.exact": "Exact execution",
  "routine.correlation.heuristic": "Estimated match",
  "routine.correlation.unmatched": "No matching task",
  "routine.process": "Process: {{status}}",
  "routine.agent": "Agent: {{status}}",
  "routine.outcome": "Objective: {{status}}",
  ...DESKTOP_NATIVE_ENGLISH,
  "office.decision.reconcile": "Needs reconciliation after restart",
  "office.decision.notPending": "No longer pending",
  "office.voice.title": "Farmer voice",
  "office.voice.connecting": "Connecting",
  "office.voice.listening": "Listening",
  "office.voice.admitting": "Receiving input",
  "office.voice.speaking": "Speaking",
  "office.voice.error": "Voice unavailable",
  "office.voice.ready": "Speak to the Farmer",
  "office.voice.pause": "Pause",
  "office.voice.resume": "Resume",
  "office.voice.hold": "Hold to talk",
  "office.voice.talking": "Talking…",
  "office.voice.stop": "Stop",
  "office.voice.details": "Details",
  "office.voice.disconnected": "Voice disconnected. Resume to reconnect and get a fresh update.",
  "office.voice.paused": "Voice paused",
  "office.request.failed": "The Farmer request failed. Check its receipt before retrying.",
  "office.request.accepted": "Received. The Farmer will update you after reviewing it.",
  "office.request.serverChanged": "The selected server changed. The request remains on its original host.",
  "office.status.summary":
    "{{working}} working, {{needs_you}} need a decision, {{failed}} failed, {{review}} ready for review, and {{done}} stopped. Stopped tasks may still need verification.",
  ...
  "dialog.phone.voiceSecure": "Secure HTTPS is selected, so microphone and voice will work on mobile.",
  ...
  "dialog.phone.door.anywhere":
    "works anywhere · the key is baked in, so no wifi or tailnet needed. once armed, the cow keeps this link current in its slack DM.",
