export const dict = {
  ...
  "command.work.open": "Open activity panel",
  "command.work.open.description": "Show running and finished work for this session",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by cow_code",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in cow_code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in cow_code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in cow_code.",
  ...
  "prompt.action.stopDictation": "Stop recording",
  "prompt.dictation.transcribing": "Transcribing…",
  "prompt.dictation.error": "Could not transcribe audio",
  "prompt.dictation.noMicPermission": "Microphone access is required for dictation",
  "prompt.dictation.noProvider": "Connect OpenAI (or set OPENAI_API_KEY) to enable voice dictation",
  ...
  "dialog.server.description": "Switch which cow_code server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "cow_code",
  ...
  "wsl.onboarding.checkingOpencode": "Checking cow_code...",
  "wsl.onboarding.checkingOpencodeIn": "Checking cow_code in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating cow_code...",
  "wsl.onboarding.updatingOpencodeIn": "Updating cow_code in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update cow_code in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update cow_code",
  "wsl.onboarding.opencodeReadyIn": "cow_code is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "cow_code is ready.",
  "wsl.onboarding.installOpencodeIn": "Install cow_code in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install cow_code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "cow_code not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before cow_code can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "cow_code could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen cow_code.",
  ...
  "work.finished.title": "Finished",
  "work.finished.clear": "Clear",
  "work.status.completed": "Done",
  "work.status.error": "Failed",
  "work.chip.finished": "{{count}} finished",
  "work.column.status": "Status",
  "work.column.duration": "Duration",
  "work.column.tokens": "Tokens",
  "work.column.cost": "Cost",
  ...
  "toast.update.description": "A new version of cow_code ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the cow_code team",
  ...
  "sidebar.gettingStarted.line1": "cow_code includes free models so you can start immediately.",
  ...
  "settings.general.row.language.description": "Change the display language for cow_code",
  ...
  "settings.general.row.appearance.description": "Customise how cow_code looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether cow_code follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how cow_code is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when cow_code launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of cow_code.",
  ...
  "settings.permissions.tool.memory.title": "Memory",
  "settings.permissions.tool.memory.description": "Create, update, or delete persistent memory files",
