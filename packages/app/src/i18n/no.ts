...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av cow_code",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i cow_code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i cow_code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i cow_code.",
  ...
  "prompt.action.dictate": "Dikter",
  "prompt.action.stopDictation": "Stopp opptak",
  "prompt.dictation.transcribing": "Transkriberer…",
  "prompt.dictation.error": "Kunne ikke transkribere lyden",
  "prompt.dictation.noMicPermission": "Diktering krever mikrofontilgang",
  "prompt.dictation.noProvider": "Koble til OpenAI (eller sett OPENAI_API_KEY) for å aktivere diktering",
  ...
  "dialog.server.description": "Bytt hvilken cow_code-server denne appen kobler til.",
  ...
  "work.empty": "Ingenting kjører akkurat nå",
  "work.tools.title": "Kjørende verktøy",
  "work.subagents.title": "Underagenter",
  "work.badge.background": "bakgrunn",
  "work.badge.retrying": "Prøver på nytt",
  "work.tokens": "{{count}} tokens",
  "work.chip.running": "{{count}} kjørende",
  "work.open": "Se pågående arbeid",
  "work.finished.title": "Fullført",
  "work.finished.clear": "Tøm",
  "work.status.completed": "Ferdig",
  "work.status.error": "Mislyktes",
  "work.chip.finished": "{{count}} fullført",
  "work.column.status": "Status",
  "work.column.duration": "Varighet",
  "work.column.tokens": "Tokens",
  "work.column.cost": "Kostnad",
  ...
  "toast.update.description": "En ny versjon av cow_code ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til cow_code-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at cow_code ikke støtter MCP-autentisering ennå.',
  ...
  "notification.session.stuck.title": "Økten kan ha stoppet opp",
  "notification.session.stuck.silentDescription":
    "{{sessionTitle}} har vært opptatt uten aktivitet i {{minutes}} minutter",
  "notification.session.stuck.retryDescription": "{{sessionTitle}} fortsetter å prøve på nytt (forsøk {{attempt}})",
  "status.connection.reconnecting": "Mistet tilkoblingen — kobler til på nytt…",
  "toast.sidecarExit.title": "Lokal server stoppet",
  "toast.sidecarExit.description": "Den lokale opencode-serveren avsluttet uventet (kode {{code}}).",
  "toast.sidecarExit.action.restart": "Start appen på nytt",
  ...
  "sidebar.gettingStarted.line1": "cow_code inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "sidebar.group.pinned": "Festet",
  "sidebar.group.recents": "Nylige",
  ...
  "settings.desktop.wsl.description": "Kjør cow_code-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for cow_code",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan cow_code ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om cow_code skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan cow_code er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når cow_code starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av cow_code.",
  ...
  "settings.general.notifications.stuck.title": "Fastlåste økter",
  "settings.general.notifications.stuck.description": "Vis systemvarsel når en opptatt økt slutter å gjøre fremgang",
  ...
  "settings.general.sounds.moo.title": "Mø ved fullføring",
  "settings.general.sounds.moo.description": "Spill et mildt mø når en tur fullføres mens vinduet ikke er i fokus",
  ...
  "settings.permissions.tool.memory.title": "Minne",
  "settings.permissions.tool.memory.description": "Opprett, oppdater eller slett vedvarende minnefiler",
  ...
  "command.browser.new": "Ny nettleserfane",
  "command.browser.new.description": "Åpne en ny fane i nettleserpanelet",
  "command.work.open": "Åpne aktivitetspanel",
  "command.work.open.description": "Vis pågående og fullført arbeid for denne økten",
  "browser.title": "Nettleser",
  "browser.tab.untitled": "Ny fane",
  "browser.tab.close": "Lukk fane",
  "browser.urlbar.placeholder": "Skriv inn en URL",
  "browser.action.back": "Tilbake",
  "browser.action.forward": "Frem",
  "browser.action.reload": "Last inn på nytt",
  "browser.action.stop": "Stopp innlasting",
  "browser.empty": "Skriv inn en URL for å surfe",
