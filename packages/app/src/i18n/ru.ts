export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от cow_code",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в cow_code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в cow_code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в cow_code.",
  ...
  "prompt.action.dictate": "Диктовка",
  "prompt.action.stopDictation": "Остановить запись",
  "prompt.dictation.transcribing": "Расшифровка…",
  "prompt.dictation.error": "Не удалось расшифровать аудио",
  "prompt.dictation.noMicPermission": "Для диктовки нужен доступ к микрофону",
  "prompt.dictation.noProvider": "Подключите OpenAI (или задайте OPENAI_API_KEY), чтобы включить диктовку",
  ...
  "dialog.server.description": "Переключите сервер cow_code к которому подключается приложение.",
  ...
  "context.usage.subagents": "Субагенты",
  "work.empty": "Сейчас ничего не выполняется",
  "work.tools.title": "Выполняемые инструменты",
  "work.subagents.title": "Субагенты",
  "work.badge.background": "фон",
  "work.badge.retrying": "Повторная попытка",
  "work.tokens": "{{count}} токенов",
  "work.chip.running": "{{count}} выполняется",
  "work.open": "Показать текущую работу",
  "work.finished.title": "Завершено",
  "work.finished.clear": "Очистить",
  "work.status.completed": "Готово",
  "work.status.error": "Ошибка",
  "work.chip.finished": "Завершено: {{count}}",
  "work.column.status": "Статус",
  "work.column.duration": "Длительность",
  "work.column.tokens": "Токены",
  "work.column.cost": "Стоимость",
  ...
  "toast.update.description": "Новая версия cow_code ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде cow_code",
  ...
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что cow_code пока не поддерживает MCP авторизацию.',
  ...
  "notification.session.stuck.title": "Сессия, возможно, зависла",
  "notification.session.stuck.silentDescription": "{{sessionTitle}} занята без активности уже {{minutes}} минут(ы)",
  "notification.session.stuck.retryDescription": "{{sessionTitle}} продолжает повторять попытки (попытка {{attempt}})",
  "status.connection.reconnecting": "Соединение потеряно — переподключение…",
  "toast.sidecarExit.title": "Локальный сервер остановлен",
  "toast.sidecarExit.description": "Локальный сервер opencode неожиданно завершился (код {{code}}).",
  "toast.sidecarExit.action.restart": "Перезапустить приложение",
  ...
  "sidebar.gettingStarted.line1": "cow_code включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "sidebar.group.recents": "Недавние",
  ...
  "settings.desktop.wsl.description": "Запускать сервер cow_code внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения cow_code",
  "settings.general.row.appearance.title": "Внешний вид",
  "settings.general.row.appearance.description": "Настройте как cow_code выглядит на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли cow_code системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление cow_code.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске cow_code",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию cow_code.",
  ...
  "settings.general.notifications.stuck.title": "Зависшие сессии",
  "settings.general.notifications.stuck.description":
    "Показывать системное уведомление, когда занятая сессия перестаёт продвигаться",
  ...
  "settings.general.sounds.moo.title": "Мычание по завершении",
  "settings.general.sounds.moo.description": "Проигрывать мягкое мычание, когда ход завершается, а окно не в фокусе",
  ...
  "settings.permissions.tool.memory.title": "Память",
  "settings.permissions.tool.memory.description": "Создание, обновление или удаление постоянных файлов памяти",
  ...
  "command.browser.new": "Новая вкладка браузера",
  "command.browser.new.description": "Открыть новую вкладку в панели браузера",
  "command.work.open": "Открыть панель активности",
  "command.work.open.description": "Показать текущую и завершённую работу этой сессии",
  "browser.title": "Браузер",
  "browser.tab.untitled": "Новая вкладка",
  "browser.tab.close": "Закрыть вкладку",
  "browser.urlbar.placeholder": "Введите URL",
  "browser.action.back": "Назад",
  "browser.action.forward": "Вперёд",
  "browser.action.reload": "Перезагрузить",
  "browser.action.stop": "Остановить загрузку",
  "browser.empty": "Введите URL для просмотра",
}
