export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "cow_code에서 제공하는 무료 모델",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} API 키를 입력하여 계정을 연결하고 cow_code에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "를 방문하여 인증 코드를 받아 계정을 연결하고 cow_code에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "를 방문하고 아래 코드를 입력하여 계정을 연결하고 cow_code에서 {{provider}} 모델을 사용하세요.",
  ...
  "prompt.action.dictate": "받아쓰기",
  "prompt.action.stopDictation": "녹음 중지",
  "prompt.dictation.transcribing": "전사 중…",
  "prompt.dictation.error": "오디오를 전사할 수 없습니다",
  "prompt.dictation.noMicPermission": "받아쓰기에는 마이크 접근이 필요합니다",
  "prompt.dictation.noProvider": "음성 받아쓰기를 사용하려면 OpenAI를 연결하세요 (또는 OPENAI_API_KEY 설정)",
  ...
  "dialog.server.description": "이 앱이 연결할 cow_code 서버를 전환합니다.",
  ...
  "context.usage.subagents": "하위 에이전트",
  "work.empty": "지금 실행 중인 항목이 없습니다",
  "work.tools.title": "실행 중인 도구",
  "work.subagents.title": "하위 에이전트",
  "work.badge.background": "백그라운드",
  "work.badge.retrying": "재시도 중",
  "work.tokens": "{{count}} 토큰",
  "work.chip.running": "{{count}}개 실행 중",
  "work.open": "실행 중인 작업 보기",
  "work.finished.title": "완료됨",
  "work.finished.clear": "지우기",
  "work.status.completed": "완료",
  "work.status.error": "실패",
  "work.chip.finished": "{{count}}개 완료",
  "work.column.status": "상태",
  "work.column.duration": "소요 시간",
  "work.column.tokens": "토큰",
  "work.column.cost": "비용",
  "language.en": "English",
  "language.zh": "简体中文",
  "language.zht": "繁體中文",
  ...
  "toast.update.description": "cow_code의 새 버전({{version}})을 설치할 수 있습니다.",
  ...
  "error.page.report.prefix": "이 오류를 cow_code 팀에 제보해 주세요: ",
  ...
  "error.chain.mcpFailed": 'MCP 서버 "{{name}}" 실패. 참고: cow_code는 아직 MCP 인증을 지원하지 않습니다.',
  ...
  "notification.session.stuck.title": "세션이 멈췄을 수 있습니다",
  "notification.session.stuck.silentDescription": "{{sessionTitle}}이(가) {{minutes}}분 동안 활동 없이 작업 중입니다",
  "notification.session.stuck.retryDescription": "{{sessionTitle}}이(가) 계속 재시도하고 있습니다 (시도 {{attempt}}회)",
  "status.connection.reconnecting": "연결이 끊겼습니다 — 다시 연결하는 중…",
  "toast.sidecarExit.title": "로컬 서버 중지됨",
  "toast.sidecarExit.description": "로컬 opencode 서버가 예기치 않게 종료되었습니다 (코드 {{code}}).",
  "toast.sidecarExit.action.restart": "앱 다시 시작",
  ...
  "sidebar.gettingStarted.line1": "cow_code에는 무료 모델이 포함되어 있어 즉시 시작할 수 있습니다.",
  ...
  "settings.desktop.wsl.description": "Windows의 WSL 내부에서 cow_code 서버를 실행합니다.",
  ...
  "settings.general.row.language.description": "cow_code 표시 언어 변경",
  "settings.general.row.appearance.title": "모양",
  "settings.general.row.appearance.description": "기기에서 cow_code가 보이는 방식 사용자 지정",
  "settings.general.row.colorScheme.title": "색상 테마",
  "settings.general.row.colorScheme.description": "cow_code가 시스템, 라이트 또는 다크 테마를 따를지 선택하세요",
  "settings.general.row.theme.title": "테마",
  "settings.general.row.theme.description": "cow_code 테마 사용자 지정",
  ...
  "settings.updates.row.startup.description": "cow_code를 실행할 때 업데이트를 자동으로 확인합니다",
  ...
  "settings.updates.toast.latest.description": "현재 최신 버전의 cow_code를 사용 중입니다.",
  ...
  "settings.general.notifications.stuck.title": "멈춘 세션",
  "settings.general.notifications.stuck.description": "작업 중인 세션이 더 이상 진행되지 않을 때 시스템 알림 표시",
  ...
  "settings.general.sounds.moo.title": "완료 시 음매",
  "settings.general.sounds.moo.description": "창이 포커스되지 않은 상태에서 턴이 완료되면 부드러운 음매 소리를 재생합니다",
  ...
  "settings.permissions.tool.memory.title": "메모리",
  "settings.permissions.tool.memory.description": "지속 메모리 파일 생성, 업데이트 또는 삭제",
  ...
  "command.browser.toggle": "브라우저 토글",
  "command.browser.new": "새 브라우저 탭",
  "command.browser.new.description": "브라우저 패널에서 새 탭 열기",
  "command.work.open": "활동 패널 열기",
  "command.work.open.description": "이 세션의 실행 중 및 완료된 작업 표시",
  "browser.title": "브라우저",
  "browser.tab.untitled": "새 탭",
  "browser.tab.close": "탭 닫기",
  "browser.urlbar.placeholder": "URL 입력",
  "browser.action.back": "뒤로",
  "browser.action.forward": "앞으로",
  "browser.action.reload": "새로고침",
  "browser.action.stop": "로딩 중지",
  "browser.empty": "URL을 입력하여 탐색",
}
