export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "cow_codeが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、cow_codeで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してcow_codeで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、cow_codeで{{provider}}モデルを使用してください。",
  ...
  "prompt.action.dictate": "音声入力",
  "prompt.action.stopDictation": "録音を停止",
  "prompt.dictation.transcribing": "文字起こし中…",
  "prompt.dictation.error": "音声を文字起こしできませんでした",
  "prompt.dictation.noMicPermission": "音声入力にはマイクへのアクセスが必要です",
  "prompt.dictation.noProvider": "音声入力を有効にするには OpenAI を接続してください（または OPENAI_API_KEY を設定）",
  ...
  "dialog.server.description": "このアプリが接続するcow_codeサーバーを切り替えます。",
  ...
  "context.usage.subagents": "サブエージェント",
  "work.empty": "現在実行中のものはありません",
  "work.tools.title": "実行中のツール",
  "work.subagents.title": "サブエージェント",
  "work.badge.background": "バックグラウンド",
  "work.badge.retrying": "再試行中",
  "work.tokens": "{{count}} トークン",
  "work.chip.running": "{{count}} 件実行中",
  "work.open": "実行中の作業を表示",
  "work.finished.title": "完了",
  "work.finished.clear": "クリア",
  "work.status.completed": "完了",
  "work.status.error": "失敗",
  "work.chip.finished": "{{count}} 件完了",
  "work.column.status": "ステータス",
  "work.column.duration": "時間",
  "work.column.tokens": "トークン",
  "work.column.cost": "コスト",
  "language.en": "English",
  "language.zh": "简体中文",
  "language.zht": "繁體中文",
  "language.ko": "한국어",
  ...
  "toast.update.description": "cow_codeの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをcow_codeチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: cow_codeはまだMCP認証をサポートしていません。',
  ...
  "notification.session.stuck.title": "セッションが停止している可能性があります",
  "notification.session.stuck.silentDescription":
    "{{sessionTitle}} は {{minutes}} 分間アクティビティがないまま実行中です",
  "notification.session.stuck.retryDescription": "{{sessionTitle}} が再試行を繰り返しています（試行 {{attempt}} 回目）",
  "status.connection.reconnecting": "接続が切断されました — 再接続中…",
  "toast.sidecarExit.title": "ローカルサーバーが停止しました",
  "toast.sidecarExit.description": "ローカルの opencode サーバーが予期せず終了しました（コード {{code}}）。",
  "toast.sidecarExit.action.restart": "アプリを再起動",
  ...
  "sidebar.gettingStarted.line1": "cow_codeには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でcow_codeサーバーを実行します。",
  ...
  "settings.general.row.language.description": "cow_codeの表示言語を変更します",
  "settings.general.row.appearance.title": "外観",
  "settings.general.row.appearance.description": "デバイスでのcow_codeの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "cow_codeがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "cow_codeのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "cow_code の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "cow_code は最新バージョンです。",
  ...
  "settings.general.notifications.stuck.title": "スタックしたセッション",
  "settings.general.notifications.stuck.description":
    "実行中のセッションが進まなくなったときにシステム通知を表示します",
  ...
  "settings.general.sounds.moo.title": "完了時にモーと鳴く",
  "settings.general.sounds.moo.description": "ウィンドウが非アクティブなときにターンが完了すると、やさしいモーという鳴き声を再生します",
  ...
  "settings.permissions.tool.memory.title": "メモリ",
  "settings.permissions.tool.memory.description": "永続メモリファイルの作成、更新、削除",
  ...
  "command.browser.new": "新しいブラウザタブ",
  "command.browser.new.description": "ブラウザパネルで新しいタブを開く",
  "command.work.open": "アクティビティパネルを開く",
  "command.work.open.description": "このセッションの実行中および完了した作業を表示",
  "browser.title": "ブラウザ",
  "browser.tab.untitled": "新しいタブ",
  "browser.tab.close": "タブを閉じる",
  "browser.urlbar.placeholder": "URLを入力",
  "browser.action.back": "戻る",
  "browser.action.forward": "進む",
  "browser.action.reload": "再読み込み",
  "browser.action.stop": "読み込みを停止",
  "browser.empty": "URLを入力して閲覧",
}
