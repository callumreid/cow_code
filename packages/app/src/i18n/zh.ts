...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "cow_code 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 cow_code 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 cow_code 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 cow_code 中使用 {{provider}} 模型。",
  ...
  "prompt.action.dictate": "语音输入",
  "prompt.action.stopDictation": "停止录音",
  "prompt.dictation.transcribing": "转写中…",
  "prompt.dictation.error": "无法转写音频",
  "prompt.dictation.noMicPermission": "语音输入需要麦克风权限",
  "prompt.dictation.noProvider": "连接 OpenAI（或设置 OPENAI_API_KEY）以启用语音输入",
  ...
  "dialog.server.description": "切换此应用连接的 cow_code 服务器。",
  ...
  "work.empty": "当前没有正在运行的任务",
  "work.tools.title": "运行中的工具",
  "work.subagents.title": "子代理",
  "work.badge.background": "后台",
  "work.badge.retrying": "重试中",
  "work.tokens": "{{count}} Token",
  "work.chip.running": "{{count}} 个运行中",
  "work.open": "查看运行中的工作",
  "work.finished.title": "已完成",
  "work.finished.clear": "清除",
  "work.status.completed": "完成",
  "work.status.error": "失败",
  "work.chip.finished": "{{count}} 个已完成",
  "work.column.status": "状态",
  "work.column.duration": "耗时",
  "work.column.tokens": "令牌",
  "work.column.cost": "费用",
  ...
  "toast.update.description": "cow_code 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 cow_code 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: cow_code 暂不支持 MCP 认证。',
  ...
  "notification.session.stuck.title": "会话可能已卡住",
  "notification.session.stuck.silentDescription": "{{sessionTitle}} 已运行 {{minutes}} 分钟没有任何活动",
  "notification.session.stuck.retryDescription": "{{sessionTitle}} 正在反复重试（第 {{attempt}} 次尝试）",
  "status.connection.reconnecting": "连接已断开 — 正在重新连接…",
  "toast.sidecarExit.title": "本地服务器已停止",
  "toast.sidecarExit.description": "本地 opencode 服务器意外退出（代码 {{code}}）。",
  "toast.sidecarExit.action.restart": "重启应用",
  ...
  "common.pin": "置顶",
  "common.unpin": "取消置顶",
  "home.sessions.group.pinned": "已置顶",
  "common.reset": "重置",
  "common.archive": "归档",
  "common.delete": "删除",
  "common.close": "关闭",
  ...
  "sidebar.gettingStarted.line1": "cow_code 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 cow_code 服务器。",
  ...
  "settings.general.row.language.description": "更改 cow_code 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 cow_code 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 cow_code 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 cow_code 的主题。",
  ...
  "settings.updates.row.startup.description": "在 cow_code 启动时自动检查更新",
  ...
  "settings.general.notifications.stuck.title": "卡住的会话",
  "settings.general.notifications.stuck.description": "当运行中的会话不再有进展时显示系统通知",
  ...
  "settings.general.sounds.moo.title": "完成时哞叫",
  "settings.general.sounds.moo.description": "当窗口未聚焦时回合完成后播放轻柔的哞叫声",
  ...
  "settings.permissions.tool.memory.title": "记忆",
  "settings.permissions.tool.memory.description": "创建、更新或删除持久记忆文件",
  ...
  "command.browser.new": "新建浏览器标签页",
  "command.browser.new.description": "在浏览器面板中打开新标签页",
  "command.work.open": "打开活动面板",
  "command.work.open.description": "显示此会话的运行中和已完成的工作",
  "browser.title": "浏览器",
  "browser.tab.untitled": "新标签页",
  "browser.tab.close": "关闭标签页",
  "browser.urlbar.placeholder": "输入网址",
  "browser.action.back": "后退",
  "browser.action.forward": "前进",
  "browser.action.reload": "重新加载",
  "browser.action.stop": "停止加载",
