export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo cow_code",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no cow_code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no cow_code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no cow_code.",
  ...
  "prompt.action.dictate": "Ditar",
  "prompt.action.stopDictation": "Parar gravação",
  "prompt.dictation.transcribing": "Transcrevendo…",
  "prompt.dictation.error": "Não foi possível transcrever o áudio",
  "prompt.dictation.noMicPermission": "O ditado requer acesso ao microfone",
  "prompt.dictation.noProvider": "Conecte a OpenAI (ou defina OPENAI_API_KEY) para ativar o ditado",
  ...
  "dialog.server.description": "Trocar para qual servidor cow_code este aplicativo se conecta.",
  ...
  "work.empty": "Nada em execução no momento",
  "work.tools.title": "Ferramentas em execução",
  "work.subagents.title": "Subagentes",
  "work.badge.background": "segundo plano",
  "work.badge.retrying": "Tentando novamente",
  "work.tokens": "{{count}} tokens",
  "work.chip.running": "{{count}} em execução",
  "work.open": "Ver trabalho em execução",
  "work.finished.title": "Concluído",
  "work.finished.clear": "Limpar",
  "work.status.completed": "Concluído",
  "work.status.error": "Falhou",
  "work.chip.finished": "{{count}} concluídos",
  "work.column.status": "Status",
  "work.column.duration": "Duração",
  "work.column.tokens": "Tokens",
  "work.column.cost": "Custo",
  "language.en": "English",
  "language.zh": "简体中文",
  "language.zht": "繁體中文",
  "language.ko": "한국어",
  ...
  "toast.update.description": "Uma nova versão do cow_code ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do cow_code",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: cow_code ainda não suporta autenticação MCP.',
  ...
  "notification.session.stuck.title": "A sessão pode estar travada",
  "notification.session.stuck.silentDescription": "{{sessionTitle}} está ocupada sem atividade há {{minutes}} minutos",
  "notification.session.stuck.retryDescription": "{{sessionTitle}} continua tentando novamente (tentativa {{attempt}})",
  "status.connection.reconnecting": "Conexão perdida — reconectando…",
  "toast.sidecarExit.title": "Servidor local parado",
  "toast.sidecarExit.description": "O servidor local do opencode encerrou inesperadamente (código {{code}}).",
  "toast.sidecarExit.action.restart": "Reiniciar o aplicativo",
  ...
  "sidebar.gettingStarted.line1": "cow_code inclui modelos gratuitos para você começar imediatamente.",
  ...
  "sidebar.group.recents": "Recentes",
  ...
  "settings.desktop.wsl.description": "Executar o servidor cow_code dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do cow_code",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o cow_code aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o cow_code segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o cow_code é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o cow_code iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do cow_code.",
  ...
  "settings.general.notifications.stuck.title": "Sessões travadas",
  "settings.general.notifications.stuck.description":
    "Mostrar notificação do sistema quando uma sessão ocupada parar de progredir",
  ...
  "settings.general.sounds.moo.title": "Mugido ao concluir",
  "settings.general.sounds.moo.description":
    "Toca um mugido suave quando um turno termina enquanto a janela está sem foco",
  ...
  "settings.permissions.tool.memory.title": "Memória",
  "settings.permissions.tool.memory.description": "Criar, atualizar ou excluir arquivos de memória persistente",
  ...
  "command.browser.new": "Nova aba do navegador",
  "command.browser.new.description": "Abrir uma nova aba no painel do navegador",
  "command.work.open": "Abrir painel de atividade",
  "command.work.open.description": "Mostrar o trabalho em execução e concluído desta sessão",
  "browser.title": "Navegador",
  "browser.tab.untitled": "Nova aba",
  "browser.tab.close": "Fechar aba",
  "browser.urlbar.placeholder": "Digite uma URL",
  "browser.action.back": "Voltar",
  "browser.action.forward": "Avançar",
  "browser.action.reload": "Recarregar",
  "browser.action.stop": "Parar carregamento",
  "browser.empty": "Digite uma URL para navegar",
}
