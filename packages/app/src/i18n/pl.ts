export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez cow_code",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w cow_code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w cow_code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w cow_code.",
  ...
  "prompt.action.dictate": "Dyktuj",
  "prompt.action.stopDictation": "Zatrzymaj nagrywanie",
  "prompt.dictation.transcribing": "Transkrybowanie…",
  "prompt.dictation.error": "Nie udało się transkrybować audio",
  "prompt.dictation.noMicPermission": "Dyktowanie wymaga dostępu do mikrofonu",
  "prompt.dictation.noProvider": "Połącz OpenAI (lub ustaw OPENAI_API_KEY), aby włączyć dyktowanie",
  ...
  "dialog.server.description": "Przełącz serwer cow_code, z którym łączy się ta aplikacja.",
  ...
  "context.usage.subagents": "Podagenci",
  "work.empty": "Obecnie nic nie jest uruchomione",
  "work.tools.title": "Uruchomione narzędzia",
  "work.subagents.title": "Podagenci",
  "work.badge.background": "tło",
  "work.badge.retrying": "Ponawianie",
  "work.tokens": "{{count}} tokenów",
  "work.chip.running": "{{count}} w toku",
  "work.open": "Pokaż trwającą pracę",
  "work.finished.title": "Zakończone",
  "work.finished.clear": "Wyczyść",
  "work.status.completed": "Gotowe",
  "work.status.error": "Niepowodzenie",
  "work.chip.finished": "{{count}} zakończonych",
  "work.column.status": "Status",
  "work.column.duration": "Czas trwania",
  "work.column.tokens": "Tokeny",
  "work.column.cost": "Koszt",
  "language.en": "English",
  "language.zh": "简体中文",
  "language.zht": "繁體中文",
  "language.ko": "한국어",
  ...
  "toast.update.description": "Nowa wersja cow_code ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu cow_code",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, cow_code does not support MCP authentication yet.',
  ...
  "notification.session.stuck.title": "Sesja mogła utknąć",
  "notification.session.stuck.silentDescription": "{{sessionTitle}} jest zajęta bez aktywności od {{minutes}} minut",
  "notification.session.stuck.retryDescription": "{{sessionTitle}} wciąż ponawia próby (próba {{attempt}})",
  "status.connection.reconnecting": "Utracono połączenie — ponowne łączenie…",
  "toast.sidecarExit.title": "Lokalny serwer zatrzymany",
  "toast.sidecarExit.description": "Lokalny serwer opencode nieoczekiwanie zakończył działanie (kod {{code}}).",
  "toast.sidecarExit.action.restart": "Uruchom aplikację ponownie",
  ...
  "sidebar.gettingStarted.line1": "cow_code zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "sidebar.group.pinned": "Przypięte",
  "sidebar.group.recents": "Ostatnie",
  ...
  "settings.desktop.wsl.description": "Run the cow_code server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla cow_code",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd cow_code na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy cow_code ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw cow_code.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania cow_code",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji cow_code.",
  ...
  "settings.general.notifications.stuck.title": "Zablokowane sesje",
  "settings.general.notifications.stuck.description":
    "Pokazuj powiadomienie systemowe, gdy zajęta sesja przestaje robić postępy",
  ...
  "settings.general.sounds.moo.title": "Muczenie po zakończeniu",
  "settings.general.sounds.moo.description": "Odtwarza łagodne muczenie, gdy tura się kończy, a okno nie jest aktywne",
  ...
  "settings.permissions.tool.memory.title": "Pamięć",
  "settings.permissions.tool.memory.description": "Tworzenie, aktualizacja lub usuwanie trwałych plików pamięci",
  ...
  "command.browser.new": "Nowa karta przeglądarki",
  "command.browser.new.description": "Otwórz nową kartę w panelu przeglądarki",
  "command.work.open": "Otwórz panel aktywności",
  "command.work.open.description": "Pokaż trwające i zakończone zadania tej sesji",
  "browser.title": "Przeglądarka",
  "browser.tab.untitled": "Nowa karta",
  "browser.tab.close": "Zamknij kartę",
  "browser.urlbar.placeholder": "Wpisz adres URL",
  "browser.action.back": "Wstecz",
  "browser.action.forward": "Dalej",
  "browser.action.reload": "Odśwież",
  "browser.action.stop": "Zatrzymaj ładowanie",
  "browser.empty": "Wpisz adres URL, aby przeglądać",
}
