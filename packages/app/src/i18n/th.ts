export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "โมเดลฟรีที่จัดหาให้โดย cow_code",
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน cow_code",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " เพื่อรวบรวมรหัสการอนุญาตของคุณเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน cow_code",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " และป้อนรหัสด้านล่างเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน cow_code",
  ...
  "prompt.action.dictate": "พิมพ์ด้วยเสียง",
  "prompt.action.stopDictation": "หยุดบันทึก",
  "prompt.dictation.transcribing": "กำลังถอดความ…",
  "prompt.dictation.error": "ไม่สามารถถอดความเสียงได้",
  "prompt.dictation.noMicPermission": "การพิมพ์ด้วยเสียงต้องใช้ไมโครโฟน",
  "prompt.dictation.noProvider": "เชื่อมต่อ OpenAI (หรือตั้งค่า OPENAI_API_KEY) เพื่อเปิดใช้การพิมพ์ด้วยเสียง",
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ cow_code ที่แอปนี้เชื่อมต่อด้วย",
  ...
  "context.usage.subagents": "เอเจนต์ย่อย",
  "work.empty": "ไม่มีอะไรกำลังทำงานอยู่ตอนนี้",
  "work.tools.title": "เครื่องมือที่กำลังทำงาน",
  "work.subagents.title": "เอเจนต์ย่อย",
  "work.badge.background": "เบื้องหลัง",
  "work.badge.retrying": "กำลังลองใหม่",
  "work.tokens": "{{count}} โทเค็น",
  "work.chip.running": "{{count}} กำลังทำงาน",
  "work.open": "ดูงานที่กำลังทำงาน",
  "work.finished.title": "เสร็จสิ้น",
  "work.finished.clear": "ล้าง",
  "work.status.completed": "เสร็จ",
  "work.status.error": "ล้มเหลว",
  "work.chip.finished": "เสร็จ {{count}} รายการ",
  "work.column.status": "สถานะ",
  "work.column.duration": "ระยะเวลา",
  "work.column.tokens": "โทเคน",
  "work.column.cost": "ค่าใช้จ่าย",
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ cow_code ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม cow_code",
  ...
  "error.chain.mcpFailed": 'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า cow_code ยังไม่รองรับการตรวจสอบสิทธิ์ MCP',
  ...
  "notification.session.stuck.title": "เซสชันอาจค้างอยู่",
  "notification.session.stuck.silentDescription":
    "{{sessionTitle}} ทำงานอยู่โดยไม่มีความเคลื่อนไหวมา {{minutes}} นาทีแล้ว",
  "notification.session.stuck.retryDescription": "{{sessionTitle}} กำลังลองใหม่ซ้ำๆ (ครั้งที่ {{attempt}})",
  "status.connection.reconnecting": "การเชื่อมต่อขาดหาย — กำลังเชื่อมต่อใหม่…",
  "toast.sidecarExit.title": "เซิร์ฟเวอร์ในเครื่องหยุดทำงาน",
  "toast.sidecarExit.description": "เซิร์ฟเวอร์ opencode ในเครื่องปิดตัวลงโดยไม่คาดคิด (โค้ด {{code}})",
  "toast.sidecarExit.action.restart": "รีสตาร์ทแอป",
  ...
  "sidebar.gettingStarted.line1": "cow_code รวมถึงโมเดลฟรีเพื่อให้คุณเริ่มต้นได้ทันที",
  ...
  "sidebar.group.pinned": "ปักหมุดแล้ว",
  "sidebar.group.recents": "ล่าสุด",
  ...
  "settings.desktop.wsl.description": "เรียกใช้เซิร์ฟเวอร์ cow_code ภายใน WSL บน Windows",
  ...
  "settings.general.row.language.description": "เปลี่ยนภาษาที่แสดงสำหรับ cow_code",
  "settings.general.row.appearance.title": "รูปลักษณ์",
  "settings.general.row.appearance.description": "ปรับแต่งวิธีการที่ cow_code มีลักษณะบนอุปกรณ์ของคุณ",
  "settings.general.row.colorScheme.title": "โทนสี",
  "settings.general.row.colorScheme.description": "เลือกว่าจะให้ cow_code ใช้ธีมตามระบบ สว่าง หรือมืด",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งวิธีการที่ cow_code มีธีม",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ cow_code เปิดใช้งาน",
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้งาน cow_code เวอร์ชันล่าสุด",
  ...
  "settings.general.notifications.stuck.title": "เซสชันที่ค้าง",
  "settings.general.notifications.stuck.description": "แสดงการแจ้งเตือนระบบเมื่อเซสชันที่กำลังทำงานไม่มีความคืบหน้า",
  ...
  "settings.general.sounds.moo.title": "เสียงมอเมื่อเสร็จสิ้น",
  "settings.general.sounds.moo.description": "เล่นเสียงมอเบา ๆ เมื่อเทิร์นเสร็จสิ้นขณะที่หน้าต่างไม่ได้โฟกัส",
  ...
  "settings.permissions.tool.memory.title": "หน่วยความจำ",
  "settings.permissions.tool.memory.description": "สร้าง อัปเดต หรือลบไฟล์หน่วยความจำถาวร",
  ...
  "command.browser.new": "แท็บเบราว์เซอร์ใหม่",
  "command.browser.new.description": "เปิดแท็บใหม่ในแผงเบราว์เซอร์",
  "command.work.open": "เปิดแผงกิจกรรม",
  "command.work.open.description": "แสดงงานที่กำลังทำและเสร็จสิ้นของเซสชันนี้",
  "browser.title": "เบราว์เซอร์",
  "browser.tab.untitled": "แท็บใหม่",
  "browser.tab.close": "ปิดแท็บ",
  "browser.urlbar.placeholder": "ป้อน URL",
  "browser.action.back": "ย้อนกลับ",
  "browser.action.forward": "ไปข้างหน้า",
  "browser.action.reload": "โหลดใหม่",
  "browser.action.stop": "หยุดโหลด",
  "browser.empty": "ป้อน URL เพื่อท่องเว็บ",
}
