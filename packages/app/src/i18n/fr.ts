export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par cow_code",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans cow_code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans cow_code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans cow_code.",
  ...
  "prompt.action.dictate": "Dicter",
  "prompt.action.stopDictation": "Arrêter l'enregistrement",
  "prompt.dictation.transcribing": "Transcription…",
  "prompt.dictation.error": "Impossible de transcrire l'audio",
  "prompt.dictation.noMicPermission": "L'accès au microphone est requis pour la dictée",
  "prompt.dictation.noProvider": "Connectez OpenAI (ou définissez OPENAI_API_KEY) pour activer la dictée",
  ...
  "dialog.server.description": "Changez le serveur cow_code auquel cette application se connecte.",
  ...
  "command.usage.open": "Voir l'utilisation",
  "usage.title": "Utilisation",
  "usage.perSession": "Coût et jetons par session dans ce projet",
  "usage.totalCost": "Coût total",
  "usage.totalTokens": "Jetons totaux",
  "usage.sessions": "Sessions",
  "usage.subagentTag": "sous-agent",
  "usage.partial": "{{loaded}} sur {{total}} sessions chargées. Les totaux ne couvrent que les sessions chargées.",
  "usage.empty": "Aucune session avec utilisation enregistrée.",
  ...
  "context.usage.subagents": "Sous-agents",
  "work.empty": "Rien en cours d'exécution",
  "work.tools.title": "Outils en cours d'exécution",
  "work.subagents.title": "Sous-agents",
  "work.badge.background": "arrière-plan",
  "work.badge.retrying": "Nouvelle tentative",
  "work.tokens": "{{count}} jetons",
  "work.chip.running": "{{count}} en cours",
  "work.open": "Voir le travail en cours",
  "work.finished.title": "Terminé",
  "work.finished.clear": "Effacer",
  "work.status.completed": "Terminé",
  "work.status.error": "Échec",
  "work.chip.finished": "{{count}} terminés",
  "work.column.status": "Statut",
  "work.column.duration": "Durée",
  "work.column.tokens": "Jetons",
  "work.column.cost": "Coût",
  "language.en": "English",
  "language.zh": "简体中文",
  "language.zht": "繁體中文",
  "language.ko": "한국어",
  ...
  "command.permissions.bypass.enable": "Contourner toutes les autorisations",
  "command.permissions.bypass.disable": "Arrêter de contourner les autorisations",
  "toast.permissions.bypass.on.title": "Contournement de toutes les autorisations",
  "toast.permissions.bypass.on.description": "Chaque demande d'autorisation est approuvée automatiquement dans tous les projets. Les règles de refus bloquent toujours.",
  "toast.permissions.bypass.off.title": "Contournement des autorisations désactivé",
  "toast.permissions.bypass.off.description": "Les demandes d'autorisation réapparaîtront.",
  "permission.bypass.indicator": "Autorisations contournées",
  "permission.bypass.indicator.tooltip": "Toutes les demandes d'autorisation sont approuvées automatiquement. Cliquez pour désactiver.",
  "settings.general.row.bypass.title": "Contourner toutes les autorisations",
  "settings.general.row.bypass.description": "Approuver automatiquement chaque demande d'autorisation dans tous les projets. Dangereux — les règles de refus bloquent toujours.",
  ...
  "toast.update.description":
    "Une nouvelle version d'cow_code ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe cow_code",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'cow_code ne supporte pas encore l'authentification MCP.",
  ...
  "notification.session.stuck.title": "La session semble bloquée",
  "notification.session.stuck.silentDescription":
    "{{sessionTitle}} est occupée sans activité depuis {{minutes}} minutes",
  "notification.session.stuck.retryDescription": "{{sessionTitle}} réessaie en boucle (tentative {{attempt}})",
  "status.connection.reconnecting": "Connexion perdue — reconnexion…",
  "toast.sidecarExit.title": "Serveur local arrêté",
  "toast.sidecarExit.description": "Le serveur local opencode s'est arrêté de manière inattendue (code {{code}}).",
  "toast.sidecarExit.action.restart": "Redémarrer l'application",
  ...
  "sidebar.gettingStarted.line1":
    "cow_code inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur cow_code dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour cow_code",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'cow_code sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si cow_code suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'cow_code.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'cow_code",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'cow_code.",
  ...
  "settings.general.notifications.stuck.title": "Sessions bloquées",
  "settings.general.notifications.stuck.description":
    "Afficher une notification système lorsqu'une session occupée ne progresse plus",
  ...
  "settings.general.sounds.moo.title": "Meuglement à la fin",
  "settings.general.sounds.moo.description":
    "Joue un doux meuglement quand un tour se termine alors que la fenêtre n'est pas au premier plan",
  ...
  "settings.permissions.tool.memory.title": "Mémoire",
  "settings.permissions.tool.memory.description": "Créer, mettre à jour ou supprimer des fichiers de mémoire persistante",
  ...
  "dialog.remoteAccess.title": "Accès à distance",
  "dialog.remoteAccess.description": "Rejoignez vos sessions depuis un téléphone ou un autre appareil sur ce réseau.",
  "dialog.remoteAccess.toggle": "Autoriser les connexions depuis ce réseau",
  "dialog.remoteAccess.off.description": "Le serveur local n'accepte que les connexions depuis cet ordinateur. Activez cette option pour obtenir un QR code que votre téléphone peut scanner.",
  "dialog.remoteAccess.noNetwork": "Aucune adresse réseau trouvée. Connectez-vous à un réseau et réessayez.",
  "dialog.remoteAccess.scan": "Scannez avec votre téléphone pour ouvrir cet espace de travail",
  "dialog.remoteAccess.warning": "Toute personne sur ce réseau disposant de ce lien peut exécuter des commandes et lire des fichiers en votre nom. Le mot de passe aléatoire est toujours requis, mais n'activez cette option que sur des réseaux de confiance — pour un accès depuis l'extérieur, utilisez un VPN comme Tailscale. L'accès à distance se désactive au redémarrage de l'application.",
  "command.browser.toggle": "Basculer le navigateur",
  "command.browser.new": "Nouvel onglet du navigateur",
  "command.browser.new.description": "Ouvrir un nouvel onglet dans le panneau du navigateur",
  "command.work.open": "Ouvrir le panneau d'activité",
  "command.work.open.description": "Afficher le travail en cours et terminé de cette session",
  "browser.title": "Navigateur",
  "browser.tab.untitled": "Nouvel onglet",
  "browser.tab.close": "Fermer l'onglet",
  "browser.urlbar.placeholder": "Saisissez une URL",
  "browser.action.back": "Retour",
  "browser.action.forward": "Suivant",
  "browser.action.reload": "Recharger",
  "browser.action.stop": "Arrêter le chargement",
  "browser.empty": "Saisissez une URL pour naviguer",
}
