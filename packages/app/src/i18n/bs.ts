export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje cow_code",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u cow_code-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u cow_code-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u cow_code-u.",
  ...
  "prompt.action.dictate": "Diktiraj",
  "prompt.action.stopDictation": "Zaustavi snimanje",
  "prompt.dictation.transcribing": "Transkribujem…",
  "prompt.dictation.error": "Nije moguće transkribovati audio",
  "prompt.dictation.noMicPermission": "Diktiranje zahtijeva pristup mikrofonu",
  "prompt.dictation.noProvider": "Povežite OpenAI (ili postavite OPENAI_API_KEY) da omogućite diktiranje",
  ...
  "dialog.server.description": "Promijeni na koji se cow_code server ova aplikacija povezuje.",
  ...
  "context.usage.subagents": "Podagenti",
  "work.empty": "Trenutno ništa nije pokrenuto",
  "work.tools.title": "Pokrenuti alati",
  "work.subagents.title": "Podagenti",
  "work.badge.background": "pozadina",
  "work.badge.retrying": "Ponovni pokušaj",
  "work.tokens": "{{count}} tokena",
  "work.chip.running": "{{count}} u toku",
  "work.open": "Prikaži rad u toku",
  "work.finished.title": "Završeno",
  "work.finished.clear": "Očisti",
  "work.status.completed": "Gotovo",
  "work.status.error": "Neuspjelo",
  "work.chip.finished": "{{count}} završeno",
  "work.column.status": "Status",
  "work.column.duration": "Trajanje",
  "work.column.tokens": "Tokeni",
  "work.column.cost": "Trošak",
  ...
  "toast.update.description": "Nova verzija cow_code-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku cow_code timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: cow_code još ne podržava MCP autentifikaciju.',
  ...
  "notification.session.stuck.title": "Sesija je možda zaglavljena",
  "notification.session.stuck.silentDescription": "{{sessionTitle}} je zauzeta bez aktivnosti već {{minutes}} minuta",
  "notification.session.stuck.retryDescription": "{{sessionTitle}} stalno pokušava ponovo (pokušaj {{attempt}})",
  "status.connection.reconnecting": "Veza je prekinuta — ponovno povezivanje…",
  "toast.sidecarExit.title": "Lokalni server zaustavljen",
  "toast.sidecarExit.description": "Lokalni opencode server se neočekivano ugasio (kod {{code}}).",
  "toast.sidecarExit.action.restart": "Ponovo pokreni aplikaciju",
  ...
  "sidebar.gettingStarted.line1": "cow_code uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "sidebar.group.pinned": "Zakačene",
  "sidebar.group.recents": "Nedavno",
  ...
  "settings.desktop.wsl.description": "Pokreni cow_code server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u cow_code-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako cow_code izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li cow_code prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu cow_code-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se cow_code pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju cow_code-a.",
  ...
  "settings.general.notifications.stuck.title": "Zaglavljene sesije",
  "settings.general.notifications.stuck.description":
    "Prikaži sistemsku notifikaciju kada zauzeta sesija prestane napredovati",
  ...
  "settings.permissions.tool.memory.title": "Memorija",
  "settings.permissions.tool.memory.description": "Kreiranje, ažuriranje ili brisanje trajnih memorijskih datoteka",
  ...
  "command.work.open": "Otvori panel aktivnosti",
  "command.work.open.description": "Prikaži tekući i završeni rad ove sesije",
