export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من cow_code",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في cow_code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في cow_code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في cow_code.",
  ...
  "prompt.action.dictate": "إملاء",
  "prompt.action.stopDictation": "إيقاف التسجيل",
  "prompt.dictation.transcribing": "جارٍ التفريغ…",
  "prompt.dictation.error": "تعذّر تفريغ الصوت",
  "prompt.dictation.noMicPermission": "يتطلب الإملاء الوصول إلى الميكروفون",
  "prompt.dictation.noProvider": "اربط OpenAI (أو عيّن OPENAI_API_KEY) لتفعيل الإملاء الصوتي",
  ...
  "dialog.server.description": "تبديل خادم cow_code الذي يتصل به هذا التطبيق.",
  ...
  "context.usage.subagents": "الوكلاء الفرعيون",
  "work.empty": "لا شيء قيد التشغيل الآن",
  "work.tools.title": "الأدوات قيد التشغيل",
  "work.subagents.title": "الوكلاء الفرعيون",
  "work.badge.background": "الخلفية",
  "work.badge.retrying": "إعادة المحاولة",
  "work.tokens": "{{count}} رمز",
  "work.chip.running": "{{count}} قيد التشغيل",
  "work.open": "عرض العمل الجاري",
  "work.finished.title": "منتهية",
  "work.finished.clear": "مسح",
  "work.status.completed": "تم",
  "work.status.error": "فشل",
  "work.chip.finished": "{{count}} منتهية",
  "work.column.status": "الحالة",
  "work.column.duration": "المدة",
  "work.column.tokens": "الرموز",
  "work.column.cost": "التكلفة",
  "language.en": "English",
  "language.zh": "简体中文",
  "language.zht": "繁體中文",
  "language.ko": "한국어",
  ...
  "toast.update.description": "نسخة جديدة من cow_code ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق cow_code",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن cow_code لا يدعم مصادقة MCP بعد.',
  ...
  "notification.session.stuck.title": "قد تكون الجلسة عالقة",
  "notification.session.stuck.silentDescription": "{{sessionTitle}} مشغولة دون أي نشاط منذ {{minutes}} دقائق",
  "notification.session.stuck.retryDescription": "{{sessionTitle}} تستمر في إعادة المحاولة (المحاولة {{attempt}})",
  "status.connection.reconnecting": "انقطع الاتصال — جارٍ إعادة الاتصال…",
  "toast.sidecarExit.title": "توقف الخادم المحلي",
  "toast.sidecarExit.description": "توقف خادم opencode المحلي بشكل غير متوقع (الرمز {{code}}).",
  "toast.sidecarExit.action.restart": "إعادة تشغيل التطبيق",
  ...
  "sidebar.gettingStarted.line1": "يتضمن cow_code نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم cow_code داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ cow_code",
  "settings.general.row.appearance.title": "المظهر",
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور cow_code على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان cow_code يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة cow_code.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل cow_code",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من cow_code.",
  ...
  "settings.general.notifications.stuck.title": "الجلسات العالقة",
  "settings.general.notifications.stuck.description": "إظهار إشعار النظام عندما تتوقف جلسة مشغولة عن إحراز تقدم",
  ...
  "settings.general.sounds.moo.title": "خوار عند الاكتمال",
  "settings.general.sounds.moo.description": "تشغيل خوار لطيف عند اكتمال الدور بينما النافذة غير نشطة",
  ...
  "settings.permissions.tool.memory.title": "الذاكرة",
  "settings.permissions.tool.memory.description": "إنشاء ملفات الذاكرة الدائمة أو تحديثها أو حذفها",
  ...
  "command.browser.new": "علامة تبويب متصفح جديدة",
  "command.browser.new.description": "افتح علامة تبويب جديدة في لوحة المتصفح",
  "command.work.open": "فتح لوحة النشاط",
  "command.work.open.description": "عرض العمل الجاري والمنتهي لهذه الجلسة",
  "browser.title": "المتصفح",
  "browser.tab.untitled": "علامة تبويب جديدة",
  "browser.tab.close": "إغلاق علامة التبويب",
  "browser.urlbar.placeholder": "أدخل عنوان URL",
  "browser.action.back": "رجوع",
  "browser.action.forward": "تقدم",
  "browser.action.reload": "إعادة التحميل",
  "browser.action.stop": "إيقاف التحميل",
  "browser.empty": "أدخل عنوان URL للتصفح",
}
