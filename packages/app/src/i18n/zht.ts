...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "cow_code 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 cow_code 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 cow_code 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 cow_code 中使用 {{provider}} 模型。",
  ...
  "prompt.action.dictate": "語音輸入",
  "prompt.action.stopDictation": "停止錄音",
  "prompt.dictation.transcribing": "轉寫中…",
  "prompt.dictation.error": "無法轉寫音訊",
  "prompt.dictation.noMicPermission": "語音輸入需要麥克風權限",
  "prompt.dictation.noProvider": "連接 OpenAI（或設定 OPENAI_API_KEY）以啟用語音輸入",
  ...
  "dialog.server.description": "切換此應用程式連線的 cow_code 伺服器。",
  ...
  "context.usage.subagents": "子代理",
  "work.empty": "目前沒有正在執行的任務",
  "work.tools.title": "執行中的工具",
  "work.subagents.title": "子代理",
  "work.badge.background": "背景",
  "work.badge.retrying": "重試中",
  "work.tokens": "{{count}} Token",
  "work.chip.running": "{{count}} 個執行中",
  "work.open": "檢視執行中的工作",
  "work.finished.title": "已完成",
  "work.finished.clear": "清除",
  "work.status.completed": "完成",
  "work.status.error": "失敗",
  "work.chip.finished": "{{count}} 個已完成",
  "work.column.status": "狀態",
  "work.column.duration": "耗時",
  "work.column.tokens": "權杖",
  "work.column.cost": "費用",
  ...
  "toast.update.description": "cow_code 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 cow_code 團隊",
  ...
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: cow_code 暫不支援 MCP 認證。',
  ...
  "notification.session.stuck.title": "工作階段可能已卡住",
  "notification.session.stuck.silentDescription": "{{sessionTitle}} 已執行 {{minutes}} 分鐘沒有任何活動",
  "notification.session.stuck.retryDescription": "{{sessionTitle}} 正在反覆重試（第 {{attempt}} 次嘗試）",
  "status.connection.reconnecting": "連線中斷 — 正在重新連線…",
  "toast.sidecarExit.title": "本機伺服器已停止",
  "toast.sidecarExit.description": "本機 opencode 伺服器意外結束（代碼 {{code}}）。",
  "toast.sidecarExit.action.restart": "重新啟動應用程式",
  ...
  "sidebar.gettingStarted.line1": "cow_code 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 cow_code 伺服器。",
  ...
  "settings.general.row.language.description": "變更 cow_code 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 cow_code 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 cow_code 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 cow_code 的主題。",
  ...
  "settings.updates.row.startup.description": "在 cow_code 啟動時自動檢查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 cow_code。",
  ...
  "settings.general.notifications.stuck.title": "卡住的工作階段",
  "settings.general.notifications.stuck.description": "當執行中的工作階段不再有進展時顯示系統通知",
  ...
  "settings.general.sounds.moo.title": "完成時哞叫",
  "settings.general.sounds.moo.description": "當視窗未聚焦時回合完成後播放輕柔的哞叫聲",
  ...
  "settings.permissions.tool.memory.title": "記憶",
  "settings.permissions.tool.memory.description": "建立、更新或刪除持久記憶檔案",
  ...
  "command.browser.new": "新增瀏覽器分頁",
  "command.browser.new.description": "在瀏覽器面板中開啟新分頁",
  "command.work.open": "開啟活動面板",
  "command.work.open.description": "顯示此工作階段的執行中與已完成工作",
  "browser.title": "瀏覽器",
  "browser.tab.untitled": "新分頁",
  "browser.tab.close": "關閉分頁",
  "browser.urlbar.placeholder": "輸入網址",
  "browser.action.back": "返回",
  "browser.action.forward": "前進",
  "browser.action.reload": "重新載入",
  "browser.action.stop": "停止載入",
  "browser.empty": "輸入網址開始瀏覽",
