export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від cow_code",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у cow_code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у cow_code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у cow_code.",
  ...
  "prompt.action.dictate": "Диктування",
  "prompt.action.stopDictation": "Зупинити запис",
  "prompt.dictation.transcribing": "Розшифровка…",
  "prompt.dictation.error": "Не вдалося розшифрувати аудіо",
  "prompt.dictation.noMicPermission": "Для диктування потрібен доступ до мікрофона",
  "prompt.dictation.noProvider": "Підключіть OpenAI (або задайте OPENAI_API_KEY), щоб увімкнути диктування",
  ...
  "dialog.server.description": "Перемкніть сервер cow_code, до якого підключається ця програма.",
  ...
  "command.usage.open": "View usage",
  "usage.title": "Usage",
  "usage.perSession": "Cost and tokens per session in this project",
  "usage.totalCost": "Total cost",
  "usage.totalTokens": "Total tokens",
  "usage.sessions": "Sessions",
  "usage.subagentTag": "subagent",
  "usage.partial": "Showing {{loaded}} of {{total}} loaded sessions. Totals cover loaded sessions only.",
  "usage.empty": "No sessions with recorded usage yet.",
  ...
  "context.usage.subagents": "Субагенти",
  "work.empty": "Зараз нічого не виконується",
  "work.tools.title": "Інструменти, що виконуються",
  "work.subagents.title": "Субагенти",
  "work.badge.background": "фон",
  "work.badge.retrying": "Повторна спроба",
  "work.tokens": "{{count}} токенів",
  "work.chip.running": "{{count}} виконується",
  "work.open": "Показати поточну роботу",
  "work.finished.title": "Завершено",
  "work.finished.clear": "Очистити",
  "work.status.completed": "Готово",
  "work.status.error": "Помилка",
  "work.chip.finished": "Завершено: {{count}}",
  "work.column.status": "Статус",
  "work.column.duration": "Тривалість",
  "work.column.tokens": "Токени",
  "work.column.cost": "Вартість",
  ...
  "command.permissions.bypass.enable": "Bypass all permissions",
  "command.permissions.bypass.disable": "Stop bypassing permissions",
  "toast.permissions.bypass.on.title": "Bypassing all permissions",
  "toast.permissions.bypass.on.description": "Every permission request is auto-approved across all projects. Denied rules still block.",
  "toast.permissions.bypass.off.title": "Permission bypass off",
  "toast.permissions.bypass.off.description": "Permission requests will prompt again.",
  "permission.bypass.indicator": "Bypassing permissions",
  "permission.bypass.indicator.tooltip": "All permission prompts are auto-approved. Click to turn off.",
  "settings.general.row.bypass.title": "Bypass all permissions",
  "settings.general.row.bypass.description": "Auto-approve every permission request across all projects. Dangerous — denied rules still block.",
  ...
  "toast.update.description": "Нова версія cow_code ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді cow_code",
  ...
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, cow_code ще не підтримує автентифікацію MCP.',
  ...
  "notification.session.stuck.title": "Сесія, можливо, зависла",
  "notification.session.stuck.silentDescription": "{{sessionTitle}} зайнята без активності вже {{minutes}} хвилин",
  "notification.session.stuck.retryDescription": "{{sessionTitle}} продовжує повторювати спроби (спроба {{attempt}})",
  "status.connection.reconnecting": "З'єднання втрачено — повторне підключення…",
  "toast.sidecarExit.title": "Локальний сервер зупинено",
  "toast.sidecarExit.description": "Локальний сервер opencode неочікувано завершився (код {{code}}).",
  "toast.sidecarExit.action.restart": "Перезапустити застосунок",
  ...
  "sidebar.gettingStarted.line1": "cow_code містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "sidebar.group.recents": "Нещодавні",
  ...
  "settings.desktop.wsl.description": "Запускати сервер cow_code всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу cow_code",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд cow_code на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи cow_code використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему cow_code.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску cow_code",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію cow_code.",
  ...
  "settings.general.notifications.stuck.title": "Завислі сесії",
  "settings.general.notifications.stuck.description":
    "Показувати системне сповіщення, коли зайнята сесія перестає просуватися",
  ...
  "settings.general.sounds.moo.title": "Мукання після завершення",
  "settings.general.sounds.moo.description": "Відтворювати лагідне мукання, коли хід завершується, а вікно не у фокусі",
  ...
  "settings.permissions.tool.memory.title": "Пам'ять",
  "settings.permissions.tool.memory.description": "Створення, оновлення або видалення постійних файлів пам'яті",
  ...
  "dialog.remoteAccess.title": "Віддалений доступ",
  "dialog.remoteAccess.description": "Приєднуйтеся до своїх сесій з телефона чи іншого пристрою в цій мережі.",
  "dialog.remoteAccess.toggle": "Дозволити підключення з цієї мережі",
  "dialog.remoteAccess.off.description": "Локальний сервер приймає підключення лише з цього комп'ютера. Увімкніть, щоб отримати QR-код, який можна відсканувати телефоном.",
  "dialog.remoteAccess.noNetwork": "Мережеву адресу не знайдено. Підключіться до мережі та спробуйте ще раз.",
  "dialog.remoteAccess.scan": "Відскануйте телефоном, щоб відкрити цей робочий простір",
  "dialog.remoteAccess.warning": "Будь-хто в цій мережі з цим посиланням може виконувати команди та читати файли від вашого імені. Випадковий пароль потрібен завжди, але вмикайте це лише в довірених мережах — для доступу ззовні використовуйте VPN, як-от Tailscale. Віддалений доступ вимикається після перезапуску застосунку.",
  "command.browser.toggle": "Перемкнути браузер",
  "command.browser.new": "Нова вкладка браузера",
  "command.browser.new.description": "Відкрити нову вкладку в панелі браузера",
  "command.work.open": "Відкрити панель активності",
  "command.work.open.description": "Показати поточну та завершену роботу цієї сесії",
  "browser.title": "Браузер",
  "browser.tab.untitled": "Нова вкладка",
  "browser.tab.close": "Закрити вкладку",
  "browser.urlbar.placeholder": "Введіть URL",
  "browser.action.back": "Назад",
  "browser.action.forward": "Вперед",
  "browser.action.reload": "Перезавантажити",
  "browser.action.stop": "Зупинити завантаження",
  "browser.empty": "Введіть URL для перегляду",
}
