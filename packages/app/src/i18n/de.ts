...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von cow_code",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in cow_code zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in cow_code zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in cow_code zu nutzen.",
  ...
  "prompt.action.dictate": "Diktieren",
  "prompt.action.stopDictation": "Aufnahme stoppen",
  "prompt.dictation.transcribing": "Transkribiere…",
  "prompt.dictation.error": "Audio konnte nicht transkribiert werden",
  "prompt.dictation.noMicPermission": "Für das Diktieren ist Mikrofonzugriff erforderlich",
  "prompt.dictation.noProvider": "Verbinde OpenAI (oder setze OPENAI_API_KEY), um Diktieren zu aktivieren",
  ...
  "dialog.server.description": "Wechseln Sie den cow_code-Server, mit dem sich diese App verbindet.",
  ...
  "command.usage.open": "Nutzung anzeigen",
  "usage.title": "Nutzung",
  "usage.perSession": "Kosten und Tokens pro Sitzung in diesem Projekt",
  "usage.totalCost": "Gesamtkosten",
  "usage.totalTokens": "Tokens gesamt",
  "usage.sessions": "Sitzungen",
  "usage.subagentTag": "Subagent",
  "usage.partial": "{{loaded}} von {{total}} geladenen Sitzungen. Summen umfassen nur geladene Sitzungen.",
  "usage.empty": "Noch keine Sitzungen mit erfasster Nutzung.",
  ...
  "context.usage.subagents": "Subagenten",
  "work.empty": "Gerade läuft nichts",
  "work.tools.title": "Laufende Tools",
  "work.subagents.title": "Subagenten",
  "work.badge.background": "Hintergrund",
  "work.badge.retrying": "Erneuter Versuch",
  "work.tokens": "{{count}} Token",
  "work.chip.running": "{{count}} laufend",
  "work.open": "Laufende Arbeit anzeigen",
  "work.finished.title": "Abgeschlossen",
  "work.finished.clear": "Löschen",
  "work.status.completed": "Fertig",
  "work.status.error": "Fehlgeschlagen",
  "work.chip.finished": "{{count}} abgeschlossen",
  "work.column.status": "Status",
  "work.column.duration": "Dauer",
  "work.column.tokens": "Tokens",
  "work.column.cost": "Kosten",
  "language.en": "English",
  "language.zh": "简体中文",
  "language.zht": "繁體中文",
  "language.ko": "한국어",
  ...
  "command.permissions.bypass.enable": "Alle Berechtigungen umgehen",
  "command.permissions.bypass.disable": "Berechtigungen nicht mehr umgehen",
  "toast.permissions.bypass.on.title": "Alle Berechtigungen werden umgangen",
  "toast.permissions.bypass.on.description": "Jede Berechtigungsanfrage wird projektübergreifend automatisch genehmigt. Verbotsregeln blockieren weiterhin.",
  "toast.permissions.bypass.off.title": "Berechtigungs-Bypass aus",
  "toast.permissions.bypass.off.description": "Berechtigungsanfragen fragen wieder nach.",
  "permission.bypass.indicator": "Berechtigungen werden umgangen",
  "permission.bypass.indicator.tooltip": "Alle Berechtigungsanfragen werden automatisch genehmigt. Zum Deaktivieren klicken.",
  "settings.general.row.bypass.title": "Alle Berechtigungen umgehen",
  "settings.general.row.bypass.description": "Jede Berechtigungsanfrage projektübergreifend automatisch genehmigen. Gefährlich – Verbotsregeln blockieren weiterhin.",
  ...
  "toast.update.description": "Eine neue Version von cow_code ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem cow_code-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: cow_code unterstützt noch keine MCP-Authentifizierung.',
  ...
  "notification.session.stuck.title": "Sitzung hängt möglicherweise",
  "notification.session.stuck.silentDescription":
    "{{sessionTitle}} ist seit {{minutes}} Minuten ohne Aktivität beschäftigt",
  "notification.session.stuck.retryDescription": "{{sessionTitle}} versucht es wiederholt erneut (Versuch {{attempt}})",
  "status.connection.reconnecting": "Verbindung unterbrochen — Verbindung wird wiederhergestellt…",
  "toast.sidecarExit.title": "Lokaler Server gestoppt",
  "toast.sidecarExit.description": "Der lokale opencode-Server wurde unerwartet beendet (Code {{code}}).",
  "toast.sidecarExit.action.restart": "App neu starten",
  ...
  "sidebar.gettingStarted.line1": "cow_code enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "cow_code-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für cow_code ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie cow_code auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob cow_code dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von cow_code anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von cow_code automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von cow_code.",
  ...
  "settings.general.notifications.stuck.title": "Hängende Sitzungen",
  "settings.general.notifications.stuck.description":
    "Systembenachrichtigung anzeigen, wenn eine beschäftigte Sitzung keinen Fortschritt mehr macht",
  ...
  "settings.general.sounds.moo.title": "Muhen bei Abschluss",
  "settings.general.sounds.moo.description":
    "Spielt ein sanftes Muh, wenn ein Zug abgeschlossen wird, während das Fenster nicht fokussiert ist",
  ...
  "settings.permissions.tool.memory.title": "Speicher",
  "settings.permissions.tool.memory.description": "Dauerhafte Speicherdateien erstellen, aktualisieren oder löschen",
  ...
  "command.browser.new": "Neuer Browser-Tab",
  "command.browser.new.description": "Einen neuen Tab im Browser-Panel öffnen",
  "command.work.open": "Aktivitätsbereich öffnen",
  "command.work.open.description": "Laufende und abgeschlossene Arbeit dieser Sitzung anzeigen",
  "browser.title": "Browser",
  "browser.tab.untitled": "Neuer Tab",
  "browser.tab.close": "Tab schließen",
  "browser.urlbar.placeholder": "URL eingeben",
  "browser.action.back": "Zurück",
  "browser.action.forward": "Vorwärts",
  "browser.action.reload": "Neu laden",
  "browser.action.stop": "Laden stoppen",
  "browser.empty": "URL eingeben, um zu surfen",
