export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por cow_code",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en cow_code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en cow_code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en cow_code.",
  ...
  "prompt.action.dictate": "Dictar",
  "prompt.action.stopDictation": "Detener grabación",
  "prompt.dictation.transcribing": "Transcribiendo…",
  "prompt.dictation.error": "No se pudo transcribir el audio",
  "prompt.dictation.noMicPermission": "Se requiere acceso al micrófono para dictar",
  "prompt.dictation.noProvider": "Conecta OpenAI (o define OPENAI_API_KEY) para activar el dictado",
  ...
  "dialog.server.description": "Cambiar a qué servidor de cow_code se conecta esta app.",
  ...
  "command.usage.open": "Ver uso",
  "usage.title": "Uso",
  "usage.perSession": "Costo y tokens por sesión en este proyecto",
  "usage.totalCost": "Costo total",
  "usage.totalTokens": "Tokens totales",
  "usage.sessions": "Sesiones",
  "usage.subagentTag": "subagente",
  "usage.partial": "{{loaded}} de {{total}} sesiones cargadas. Los totales cubren solo las sesiones cargadas.",
  "usage.empty": "Aún no hay sesiones con uso registrado.",
  "context.usage.cost": "Costo",
  "context.usage.clickToView": "Haz clic para ver contexto",
  "context.usage.view": "Ver uso del contexto",
  "context.usage.subagents": "Subagentes",
  "work.empty": "No hay nada en ejecución ahora",
  "work.tools.title": "Herramientas en ejecución",
  "work.subagents.title": "Subagentes",
  "work.badge.background": "segundo plano",
  "work.badge.retrying": "Reintentando",
  "work.tokens": "{{count}} tokens",
  "work.chip.running": "{{count}} en ejecución",
  "work.open": "Ver trabajo en ejecución",
  "work.finished.title": "Finalizado",
  "work.finished.clear": "Borrar",
  "work.status.completed": "Listo",
  "work.status.error": "Falló",
  "work.chip.finished": "{{count}} finalizados",
  "work.column.status": "Estado",
  "work.column.duration": "Duración",
  "work.column.tokens": "Tokens",
  "work.column.cost": "Costo",
  ...
  "command.permissions.bypass.enable": "Omitir todos los permisos",
  "command.permissions.bypass.disable": "Dejar de omitir permisos",
  "toast.permissions.bypass.on.title": "Omitiendo todos los permisos",
  "toast.permissions.bypass.on.description": "Cada solicitud de permiso se aprueba automáticamente en todos los proyectos. Las reglas de denegación siguen bloqueando.",
  "toast.permissions.bypass.off.title": "Omisión de permisos desactivada",
  "toast.permissions.bypass.off.description": "Las solicitudes de permiso volverán a preguntar.",
  "permission.bypass.indicator": "Omitiendo permisos",
  "permission.bypass.indicator.tooltip": "Todas las solicitudes de permiso se aprueban automáticamente. Haz clic para desactivar.",
  "settings.general.row.bypass.title": "Omitir todos los permisos",
  "settings.general.row.bypass.description": "Aprobar automáticamente cada solicitud de permiso en todos los proyectos. Peligroso: las reglas de denegación siguen bloqueando.",
  ...
  "toast.update.description": "Una nueva versión de cow_code ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de cow_code",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, cow_code no soporta autenticación MCP todavía.',
  ...
  "notification.session.stuck.title": "La sesión puede estar atascada",
  "notification.session.stuck.silentDescription": "{{sessionTitle}} lleva {{minutes}} minutos ocupada sin actividad",
  "notification.session.stuck.retryDescription": "{{sessionTitle}} sigue reintentando (intento {{attempt}})",
  "status.connection.reconnecting": "Conexión perdida — reconectando…",
  "toast.sidecarExit.title": "Servidor local detenido",
  "toast.sidecarExit.description": "El servidor local de opencode se cerró inesperadamente (código {{code}}).",
  "toast.sidecarExit.action.restart": "Reiniciar la aplicación",
  ...
  "home.sessions.search.messages": "Mensajes",
  ...
  "sidebar.gettingStarted.line1": "cow_code incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "sidebar.group.recents": "Recientes",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor cow_code dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para cow_code",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve cow_code en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si cow_code sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de cow_code.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia cow_code",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de cow_code.",
  ...
  "settings.general.notifications.stuck.title": "Sesiones atascadas",
  "settings.general.notifications.stuck.description":
    "Mostrar notificación del sistema cuando una sesión ocupada deja de avanzar",
  ...
  "settings.permissions.tool.memory.title": "Memoria",
  "settings.permissions.tool.memory.description": "Crear, actualizar o eliminar archivos de memoria persistente",
  ...
  "dialog.remoteAccess.title": "Acceso remoto",
  "dialog.remoteAccess.description": "Únete a tus sesiones desde un teléfono u otro dispositivo en esta red.",
  "dialog.remoteAccess.toggle": "Permitir conexiones desde esta red",
  "dialog.remoteAccess.off.description": "El servidor local solo acepta conexiones desde este equipo. Actívalo para obtener un código QR que tu teléfono pueda escanear.",
  ...
  "command.work.open": "Abrir panel de actividad",
  "command.work.open.description": "Mostrar el trabajo en curso y finalizado de esta sesión",
