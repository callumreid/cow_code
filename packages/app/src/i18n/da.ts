export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af cow_code",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i cow_code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i cow_code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i cow_code.",
  ...
  "prompt.action.stopDictation": "Stop optagelse",
  "prompt.dictation.transcribing": "Transskriberer…",
  "prompt.dictation.error": "Kunne ikke transskribere lyden",
  "prompt.dictation.noMicPermission": "Diktering kræver mikrofonadgang",
  "prompt.dictation.noProvider": "Forbind OpenAI (eller sæt OPENAI_API_KEY) for at aktivere diktering",
  ...
  "dialog.server.description": "Skift hvilken cow_code-server denne app forbinder til.",
  ...
  "work.finished.title": "Afsluttet",
  "work.finished.clear": "Ryd",
  "work.status.completed": "Færdig",
  "work.status.error": "Mislykkedes",
  "work.chip.finished": "{{count}} afsluttet",
  "work.column.status": "Status",
  "work.column.duration": "Varighed",
  "work.column.tokens": "Tokens",
  "work.column.cost": "Omkostning",
  ...
  "toast.update.description": "En ny version af cow_code ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til cow_code-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, cow_code understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "cow_code inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "sidebar.group.pinned": "Fastgjorte",
  "sidebar.group.recents": "Seneste",
  ...
  "settings.desktop.wsl.description": "Kør cow_code-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for cow_code",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan cow_code ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om cow_code følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan cow_code er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når cow_code starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af cow_code.",
  ...
  "settings.general.sounds.moo.title": "Muh ved afslutning",
  "settings.general.sounds.moo.description": "Afspil et blidt muh, når en tur afsluttes, mens vinduet ikke er i fokus",
  ...
  "settings.permissions.tool.memory.title": "Hukommelse",
  "settings.permissions.tool.memory.description": "Opret, opdater eller slet vedvarende hukommelsesfiler",
  ...
  "command.browser.new": "Ny browserfane",
  "command.browser.new.description": "Åbn en ny fane i browserpanelet",
  "command.work.open": "Åbn aktivitetspanel",
  "command.work.open.description": "Vis igangværende og afsluttet arbejde for denne session",
  "browser.title": "Browser",
  "browser.tab.untitled": "Ny fane",
  "browser.tab.close": "Luk fane",
  "browser.urlbar.placeholder": "Indtast en URL",
  "browser.action.back": "Tilbage",
  "browser.action.forward": "Frem",
  "browser.action.reload": "Genindlæs",
  "browser.action.stop": "Stop indlæsning",
  "browser.empty": "Indtast en URL for at browse",
}
